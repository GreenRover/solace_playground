 ...
 */
  ...
  * SBB: fixes for compatibilty with WebWorker
  * - Remove localStorage requirement
  * - Cleaning up the mess with window.setTimtout and setTimout call. Dont use window any more.
  */
...
})(PahoMQTT_global !== undefined ? PahoMQTT_global : window);
return PahoMQTT;
});

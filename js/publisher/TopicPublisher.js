...
var TopicPublisher = function (topicName) {
    ...
    publisher.publish = function () {
        if (publisher.session !== null) {
            ...
            let numberOfMessages = document.getElementById('numberOfMessages').value;
            let sizeOfMessages = document.getElementById('sizeOfMessages').value;
        
            let messageText = new Array(sizeOfMessages * 1000 + 1).join( 'x' );
            ...
            try {
                for (let i=0; i<numberOfMessages; i++) {
                  ...
                  publisher.log('Message ' + i + ' published.');
                }
            } catch (error) {
                publisher.log(error.toString());
            }
